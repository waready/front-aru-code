<template>
  <q-page class="container q-ma-lg">
    <h4 class="text-center">Vocabulario de Educación</h4>
    <div class="row q-gutter-lg justify-center">
      <div
        class="col-md-2 col-sm-5 col-xs-12"
        v-for="item in menu"
        :key="item.id"
        data-aos="fade-up"
        data-aos-duration="1500"
      >
        <q-card class="my-card cursor-pointer" @click="$router.push(item.url)">
          <img
            :src="item.img"
    ...
    return {
      menu: [
        ...
        },
        {
          ...
          desc: "Palabras que hay en la naturaleza en aimara...",
          url: "/naturaleza",
        },
        {
          id: 8,
