            ...
            <q-tab-panel name="numeros1">
              ...
              <div class="row justify-center q-gutter-md q-ma-xs">
                <q-btn
                  ...
                  style="color: blue"
                  label="Otra vez"
                  @click="try_again(items1)"
                />
                <q-btn
                  outline
                  style="color: blue"
                  label="Comparar"
                  @click="comparar_elementos(items1, original1)"
                />
                <q-btn
                  outline
                  style="color: blue"
                  label="Solucinar"
                  @click="ver_resultados(original1)"
                />
              </div>
            </q-tab-panel>
            ...
            <q-tab-panel name="numeros2">
              ...
              <div class="row justify-center q-gutter-md q-ma-xs">
                <q-btn
                  ...
                  style="color: blue"
                  label="Otra vez"
                  @click="try_again(items2)"
                />
                <q-btn
                  outline
                  style="color: blue"
                  label="Comparar"
                  @click="comparar_elementos(items2, original2)"
                />
                <q-btn
                  outline
                  style="color: blue"
                  label="Solucionar"
                  @click="ver_resultados(original2)"
                />
              </div>
            </q-tab-panel>
          </q-tab-panels>
